function [mass, a_max, stress_ss_max, stress_ss_min, stress_si_max, stress_si_min, stress_b_max, stress_b_min] = Dynamic_simulation_lander_2D_3_fn(A_ss, A_si, A_b, class, number_of_Orientation)
...
C_sT = C_s'; C_bT = C_b'; C_ssT = C_ss'; C_siT = C_si';
...
for aa = 1:number_of_Orientation
    ...
    for loop = 1:number_of_loop
        ...
        %% Internal force                              
        [f_I,varepsilon_s,sigma_s,varepsilon_b,sigma_b,s_initiallength,b_initiallength] = internalforce_2(D,I_D,C_sT,C_bT,s_0,b_0,s,b,n_s,n_b,ds,db,E_s,E_b,c_s,c_b,A_s,A_b);
