...
%   ============================================================================================
% Loops for the mass of strings, 1/32,1/16,1/8,1/4...
for m_s_total = [1/32*m_load] % Test which values of m_s is the best choice
    for group = 7:7
        switch group
                case 1 % p = 2, q = 5:10
                    q_range = 5:8;
                ...
                case 3 % p = 4, q = 9:10
                    q_range = 9:10;
                    p_range = 4;
                case 4 % p = 2 and 3, q = 7:10
                    q_range = 7:10;
                    p_range = [2,3];
                case 5 % p = 2 and 4, q = 9:10
                    q_range = 9:10;
                    p_range = [2,4];
                case 6 % p = 3 and 4, q = 9:10
                    q_range = 9:10;
                    p_range = [3,4];
                case 7 % p = 2, 3 and 4, q = 9:10
                    q_range = 9:10;
                    p_range = [2,3,4];
        end
        for q = q_range
            ...
            C_sT = C_s'; C_bT = C_b';
            %% Loops for the mass of bars, 1/32,1/16,1/8,1/4...
                for m_b_total = [1/16*m_load]  % Test which values of m_b is the best choice 
