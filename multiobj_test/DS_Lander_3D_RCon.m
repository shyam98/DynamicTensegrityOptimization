function [mass, Max_g_of_different_orientation, sigma_ss_max_n, ... 
    sigma_ss_min_n, sigma_si_max_n, sigma_si_min_n, sigma_bar_max_n, ... 
    sigma_bar_min_n, sigma_ss_diff_n, sigma_si_diff_n, sigma_b_c_diff_n,...
    sigma_b_t_diff_n] = Dynamic_simulation_lander_3D_fn(r, r_ss,...
    r_si, r_b, p, q, number_of_orientation)
%This function is used to test a variety of resolutions to figure out the
%more coarse resolution that has the least amount of outliers
tic
%% Input parameters
